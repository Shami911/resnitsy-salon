                ...
                <div>
                    ...
                    <nav>
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active"> Первая карта</li>
                        </ol>
                    </nav>
                </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="/exit_CardApp/{{$item->id}}" method="POST" enctype="multipart/form-data">
                                    @csrf
...
<div class="modal fade" id="addportfolio" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/add_CardApp" method="POST" enctype="multipart/form-data">
                    @csrf
