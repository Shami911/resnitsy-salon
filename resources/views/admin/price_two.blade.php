                ...
                <div>
                    ...
                    <nav>
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active">Прайс 2</li>
                        </ol>
                    </nav>
                </div>
                    ...
                    <div class="card info-card sales-card pb-0">
                        ...
                        <div class="filter">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                ...
                                <li><a class="dropdown-item" href="/delete_price_two/{{$item->id}}">Удалить</a></li>
                            </ul>
                        </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="/exit_price_two/{{$item->id}}" method="POST">
                                    @csrf
                                    <div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="/add_price_two" method="POST">
                    @csrf
                    <div>
                        <div class="form-floating mt-2">
