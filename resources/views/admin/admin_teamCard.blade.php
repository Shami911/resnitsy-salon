                ...
                <div>
                    ...
                    <nav>
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active">Карта рекламы</li>
                        </ol>
                    </nav>
                </div>
                    ...
                    <div class="card info-card sales-card pb-0">
                       ...
                       <div class="filter">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                ...
                                <li><a class="dropdown-item" href="/delete_CardTeam/{{$item->id}}">Удалить</a></li>
                            </ul>
                            </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="/exit_CardTeam/{{$item->id}}" method="POST" enctype="multipart/form-data">
                                    @csrf
...
<div class="modal fade" id="addportfolio" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/add_Cardteam" method="POST" enctype="multipart/form-data">
                    @csrf
