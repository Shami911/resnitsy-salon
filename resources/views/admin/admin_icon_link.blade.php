...
<main id="main" class="main">
    ...
    <div class="container d-flex flex-column px-0">
        <div class="pagetitle">
            <div class="d-flex">
                <div>
                    <h1>Добавление иконок</h1>
                    <nav>
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="index.html">Главная</a></li>
                            <li class="breadcrumb-item active">Добавление иконок</li>
                        </ol>
                    </nav>
                </div>
                <button class="btn btn-carousel ms-auto" data-bs-toggle="modal" data-bs-target="#addportfolio">Добавить иконку</button>
            </div>
            <!-- End Page Title -->
        </div>
                    ...
                    <div class="card info-card sales-card pb-0">
                       ...
                       <div class="filter">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                ...
                                <li><a class="dropdown-item" href="/delete_CardApp/{{$item->id}}">Удалить</a></li>
                            </ul>
                        </div>
    
                        <div class="card-body ">
                            <h2 class="carousel-name mt-2 text-truncate w-75">{{$item->link}}</h2> 
                            <div style="background-image: url(storage/IconCard/{{$item->img}}); background-size: cover; height: 200px"></div>     
                        </div>
                    </div>
                </div>
                    </section><!-- End Hero -->
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="/exit_icon_link/{{$item->id}}" method="POST" enctype="multipart/form-data">
                                    @csrf
...
<div class="modal fade" id="addportfolio" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/add_icon_link" method="POST" enctype="multipart/form-data">
                    @csrf
