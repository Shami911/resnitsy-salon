                ...
                <div>
                    ...
                    <nav>
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active">Третья карта</li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="col">
                    <div class="card info-card sales-card pb-0">
                       ...
                       <div class="filter">
                            ...
                            <div style="background-image: url(storage/CardApp/{{$item->img}}); background-size: cover; height: 200px"></div>     
                            </div>
                    </section><!-- End Hero -->
                    </div>
                </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="/exit_card_web/{{$item->id}}" method="POST" enctype="multipart/form-data">
                                    @csrf
...
<div class="modal fade" id="addportfolio" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/add_card_web" method="POST" enctype="multipart/form-data">
                    @csrf
